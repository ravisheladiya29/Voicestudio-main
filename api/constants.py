...
# LANGFUSE_HOST is used for OTEL export (from the API container). For Docker
# self-hosting that is typically http://langfuse-web:3000.
# LANGFUSE_PUBLIC_URL is the browser-facing base used in "View Trace" links
# (e.g. http://localhost:3100). Falls back to LANGFUSE_HOST when unset.
LANGFUSE_HOST = os.getenv("LANGFUSE_HOST")
LANGFUSE_PUBLIC_URL = os.getenv("LANGFUSE_PUBLIC_URL") or LANGFUSE_HOST
...
# Model Proxy Service (MPS): hosted proxy for managed voice/STT/billing.
# Empty by default in code; set MPS_API_URL in .env (wired via docker-compose)
# to enable Models → Managed and Service Keys. Example for Dograh cloud:
#   MPS_API_URL=https://services.dograh.com
# Or point at your own MPS-compatible backend.
