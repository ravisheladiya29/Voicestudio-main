            ...
            {isOssMode && (
                <div className="flex gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-900/50 dark:bg-amber-950/30">
                    ...
                    <div className="text-sm text-amber-900 dark:text-amber-200">
                        <p className="font-medium">Managed credits are unavailable in this self-hosted build</p>
                        <p className="mt-1">
                            {BRAND_NAME} doesn&apos;t offer a managed AI provider or credit purchases in
                            this deployment. Use your own API keys (BYOK) for LLM, TTS, and STT under{" "}
                            <Link
