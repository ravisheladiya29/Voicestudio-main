...
import { BRAND_NAME, normalizeBrandText } from '@/config/brand';
                                        ...
                                        >
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span className="font-medium">{normalizeBrandText(key.name)}</span>
                                                    {key.archived_at ? (
                                ...
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text-sm text-muted-foreground">
                                            {isOSS
                                                ? "OSS builds allow one active service key. Archive it to create another."
                                                : `Managed AI services require ${BRAND_NAME} Service Keys.`}
                                        </span>
                                    )}
                                </div>
                            </div>
