                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription asChild>
                            <div className="mt-4 space-y-3">
                                <p>
                                    A starter voice agent has been created from your use case.
                                    Review and edit the prompts in the workflow editor next.
                                </p>
                                <p>
                                    Next steps: open the agent, configure your models under Models,
                                    then test a call in the editor.
                                </p>
                            </div>
                        </DialogDescription>
                    </DialogHeader>
