...
// Empty by default: this whitelabeled deployment doesn't publish its own
// container images yet, so there's nothing to check for updates against.
// Once you publish images to GHCR (or elsewhere), list them here as
// "owner/image" to re-enable the "update available" sidebar nudge.
const GHCR_IMAGES: readonly string[] = [];
