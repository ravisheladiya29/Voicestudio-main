...
import { BRAND_DOCS_URL } from "@/config/brand";
        ...
        <div className="container mx-auto px-4 py-8">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                    ...
                    <a href={`${BRAND_DOCS_URL}/voice-agent/pre-recorded-audio`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 underline">
