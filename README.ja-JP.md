...
> 🧩 **本デプロイについて**: Zenvoice は、オープンソースプロジェクト [Dograh AI](https://github.com/dograh-hq/dograh) をベースに構築されたホワイトラベル版デプロイです。BSD 2-Clause ライセンスの下で提供されています。
...
<p align="center">
  <a href="https://app.zenvoice.example">
    <img src="https://img.shields.io/badge/▶_クラウド版を試す-app.zenvoice.example-2563eb?style=for-the-badge" alt="クラウド版を試す">
  </a>
  &nbsp;
  <a href="#-クイックスタート">
...
<p align="center">
  <a href="https://docs.zenvoice.example">📖 ドキュメント</a> &nbsp;·&nbsp;
...
<p align="center">
  <img src="docs/images/hero.gif" alt="Zenvoice の動作デモ -- ワークフローを構築し、音声エージェントを起動して会話する" width="80%">
</p>
...
<div align="center">
  <a href="https://www.youtube.com/watch?v=xD9JEvfCH9k">
    <img src="https://img.youtube.com/vi/xD9JEvfCH9k/maxresdefault.jpg" alt="Better Stack による Zenvoice 紹介" width="80%" style="border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
  </a>
  <br>
  <em><strong>Better Stack</strong> による実践レビュー -- Zenvoice を詳しく紹介</em>
</div>
...
<div align="center">
  <a href="https://youtu.be/9gPneyf9M9w">
    <img src="docs/images/video_thumbnail_1.png" alt="Zenvoice のデモ動画を見る" width="70%" style="border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
  </a>
</div>
...
| **独自 LLM / STT / TTS の利用** | ✅ 任意のプロバイダー、または Zenvoice 標準スタック | 提供範囲内で設定可能 | 提供範囲内で設定可能 |
...
##### ローカルマシンに Zenvoice をダウンロードしてセットアップ

> **注記**
> 製品改善のため、匿名の利用状況データを収集します。無効にするには、起動スクリプトを実行する前に `ENABLE_TELEMETRY=false` を設定してください。

> **注記**
> リモートサーバーでプラットフォームを実行したい場合は、[ドキュメント](https://docs.zenvoice.example/deployment/docker#option-2:-remote-server-deployment)を参照してください。
...
> 🔑 **API キーは不要です。** Zenvoice には自動生成されるキーと、組み込みの LLM / TTS / STT スタックが付属しています。必要に応じて、独自の LLM、TTS、STT、または Twilio、Vonage、Telnyx などの電話連携プロバイダーをいつでも接続できます。
...
[ローカルセットアップ](https://docs.zenvoice.example/contribution/setup)を参照してください。

### セルフホストデプロイ

リモートサーバーへのデプロイや HTTPS 設定を含む詳しい手順は、[Docker デプロイガイド](https://docs.zenvoice.example/deployment/docker)を参照してください。

### クラウド版

マネージドクラウド版は [https://zenvoice.example](https://zenvoice.example/) から利用できます。

## 📚 ドキュメント

完全なドキュメントは [https://docs.zenvoice.example](https://docs.zenvoice.example/) を参照してください。
...
> ここには、あなた自身の GitHub リポジトリ / コミュニティチャンネルへのリンクを設定してください。

## 🙌 コントリビューション

コントリビューションを歓迎します。Zenvoice は 100% オープンソースであり、今後もそうあり続けます。
...
Zenvoice は [BSD 2-Clause License](LICENSE) のもとで公開されています。その構築に使われたプロジェクトと同じライセンスであり、互換性と、利用・変更・配布の自由を確保しています。

## 🏢 私たちについて

**Zenvoice** は、オープンソースの Dograh AI プラットフォームをベースに構築されたホワイトラベル版デプロイです。Dograh(Zansat Technologies Private Limited)チームによって創られたプラットフォームで、同チームは YC 卒業生と事業売却を経験した創業者で構成され、音声 AI をオープンで誰もが利用できるものに保つことに取り組んでいます。

<br><br><br>

  <p align="center">
    <a href="https://app.zenvoice.example">☁️ クラウド版を試す</a>
  </p>
