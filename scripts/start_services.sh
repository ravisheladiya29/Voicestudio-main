...
# Log startup
cd "$BASE_DIR"
echo "Starting Zenvoice Services at $(date) in BASE_DIR: ${BASE_DIR}"
...
NGINX_UPSTREAM_TEMPLATE="$BASE_DIR/nginx/zenvoice_upstream.conf.template"
NGINX_UPSTREAM_CONF="/etc/nginx/conf.d/zenvoice_upstream.conf"
